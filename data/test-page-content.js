...
const data = [
  ...
  {
    content: `
    const SAMPLE_STRING = 'carrot|order1\rbanana|order2\rbeef|order3'
  ...
  {
    content: `
    const SAMPLE_STRING = 'carrot|order1\rbanana|order2\rbeef|order3\r'
    const data = computeRegularItems(SAMPLE_STRING, 3)
  ...
  {
    content: `
    const SAMPLE_STRING = '\rcarrot|order1\rbanana|order2\rbeef|order3\r'
    const data = computeRegularItems(SAMPLE_STRING, 3)
  ...
  {
    content: `
    const SAMPLE_STRING = 'carrot|order1|quantity1\rbanana|order1|quantity8'
